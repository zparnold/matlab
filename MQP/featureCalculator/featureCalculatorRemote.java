...
/**
 * The <code>featureCalculatorRemote</code> class provides a Java RMI-compliant interface 
 * to the M-functions from the files:
 * <pre>
 *  featuresForSingleStreamOfData.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a 
 * <code>featureCalculatorRemote</code> instance when it is no longer needed to ensure 
 ...
 * generate RMI server proxy objects for instances of featureCalculator.featureCalculator.
 */
public interface featureCalculatorRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the 
     * <code>featuresForSingleStreamOfData</code> M-function with 4 input arguments.  
     *
     ...
     */
    public Object[] featuresForSingleStreamOfData(int nargout, Object... rhs) throws RemoteException;

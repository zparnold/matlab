...
/**
 * The <code>myclass</code> class provides a Java interface to the M-functions
 * from the files:
 * <pre>
 *  featuresForSingleStreamOfData.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>myclass</code> instance 
 * when it is no longer needed to ensure that native resources allocated by this class 
 * are properly freed.
 * @version 0.0
 */
public class myclass extends MWComponentInstance<myclass>
{
    /**
     ...
     */
    private myclass (final MWMCR mcr) throws MWException
    {
        super(mcr);
    ...
    /**
     * Constructs a new instance of the <code>myclass</code> class.
     */
    public myclass() throws MWException
    {
        this(MycomponentMCRFactory.newInstance());
    }
    ...
    /**
     * @deprecated Please use the constructor {@link #myclass(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     */
    public myclass(String pathToComponent) throws MWException
    {
        this(MycomponentMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>myclass</code> class. Use this constructor 
     ...
     */
    public myclass(MWComponentOptions componentOptions) throws MWException
    {
        this(MycomponentMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = MycomponentMCRFactory.newInstance();
